...
export const evidenceCatalog: Record<string, EvidenceCardData> = {
  ...
  mission({
    ...
    openingScenes: [
      scene("m05-o1", "NPC 지우", "어릴 때 멋모르고 올렸던 철없는 영상이 무단 복제되어 온라인에 계속 퍼져요... 제 이름을 검색하면 가장 위에 나와서 정상적인 생활이 불가능해요.", "npc", "worried", "digital_case_room", "left"),
